...
#2: No dicionário retornado pela função site_setup, 'site_setup': 'SITE_SETUP context_processors.py' é apenas uma chave chamada 'site_setup' com um valor de string 'SITE_SETUP context_processors.py'. No contexto dos templates, você pode acessar isso usando a variável site_setup.
